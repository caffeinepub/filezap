import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, X, B as Button } from "./index-CvZJN4Dj.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        className: `relative brand-border-gradient rounded-2xl p-8 md:p-12 text-center cursor-pointer transition-all duration-200 outline-none focus-visible:ring-2 focus-visible:ring-accent ${dragging ? "dropzone-glow scale-[1.01] bg-secondary/50" : "bg-card hover:bg-secondary/30"}`,
        children: [
