import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useNavigate, Z as Zap, L as Link, B as Button } from "./index-BvMqnfhD.js";
import { M as Merge, a as Minimize2, D as DragDropZone, A as ArrowRight, S as Scissors, F as FileOutput, I as Image } from "./DragDropZone-pzKI25H8.js";
import { F as FileText, R as RotateCcw } from "./rotate-ccw-Bmx2dr2A.js";
import { G as GripVertical } from "./grip-vertical-Q8zJw046.js";
import { L as Lock, U as Users } from "./users-C5AVVjSv.js";
/**
...
const FileType = createLucideIcon("file-type", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const pdfTools = [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "w-5 h-5" }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(LockOpen, { className: "w-5 h-5" }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(GripVertical, { className: "w-5 h-5" }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { className: "w-5 h-5" }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PenLine, { className: "w-5 h-5" }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileType, { className: "w-5 h-5" }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Table2, { className: "w-5 h-5" }),
...
const imageTools = [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileImage, { className: "w-5 h-5" }),
    color: "from-violet-500 to-violet-600"
  }
];
const trustBadges = [
...
function HomePage() {
  ...
  document.title = "BoltTools.app — Free All-in-One File Tools: Compress, Convert & Merge PDFs and Images";
  const handleFilesSelected = (f) => {
    setFiles(f);
    const file = f[0];
    if (!file) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full bg-[#09090b] text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen w-full overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-4 py-1.5 text-sm text-emerald-400 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3.5 h-3.5" }),
              "20+ Tools · 100% Free · No Signup · Instant Processing"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-400 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: "/bolttools-vs-ilovepdf",
                className: "hover:text-emerald-400 transition-colors underline underline-offset-2",
                children: "More tools than iLovePDF — all free & private →"
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl md:text-5xl lg:text-6xl font-bold leading-tight max-w-3xl", children: [
              "Merge & Compress PDFs Instantly —",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-400", children: "No Upload Required" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-gray-300 max-w-xl text-lg", children: "Process your files directly in your browser. Fast, private, and secure." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex gap-4 flex-wrap justify-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/merge-pdf", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  className: "bg-emerald-500 hover:bg-emerald-600 px-6 py-3 rounded-xl font-semibold transition flex items-center gap-2",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Merge, { className: "w-4 h-4" }),
                    " Merge PDF"
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/compress-pdf", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-sm text-gray-400", children: "🔒 No uploads • ⚡ Instant • 📱 Works on mobile" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "adsense-placeholder max-w-4xl mx-auto px-4 py-6", children: "Advertisement" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-1", children: "PDF Tools" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-400 text-sm mb-6", children: [
        "Everything you need to work with PDF files — ",
        pdfTools.length,
        " tools, all free"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4", children: pdfTools.map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
            ...
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold group-hover:text-emerald-400 transition-colors text-sm", children: tool.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: tool.desc })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4 text-gray-500 ml-auto shrink-0 group-hover:text-emerald-400 transition-colors" })
              ]
            }
          )
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "adsense-placeholder max-w-4xl mx-auto px-4 mb-6", children: "Advertisement" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 pb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-1", children: "Image Tools" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mb-6", children: "Compress, resize and convert images instantly" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: imageTools.map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          animate: { opacity: 1, y: 0 },
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold group-hover:text-emerald-400 transition-colors", children: tool.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400", children: tool.desc })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4 text-gray-500 ml-auto shrink-0 group-hover:text-emerald-400 transition-colors" })
              ]
            }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "max-w-4xl mx-auto px-4 sm:px-6 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: trustBadges.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-center text-center p-6 bg-gray-900 border border-gray-800 rounded-xl",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center text-white mb-3", children: b.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: b.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400 mt-1", children: b.sub })
        ]
      },
      b.label
    )) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-[#09090b] py-16 px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl md:text-3xl font-semibold text-center mb-4", children: [
        "Why Choose ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-400", children: "BoltTools" }),
        "?"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-gray-400 mb-10 text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/bolttools-vs-ilovepdf",
          className: "hover:text-emerald-400 underline underline-offset-2 transition-colors",
          children: "See full comparison with iLovePDF →"
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left border border-gray-800 rounded-xl overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-gray-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4", children: "Feature" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4 text-emerald-400", children: "BoltTools" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4 text-gray-400", children: "Traditional Tools" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "divide-y divide-gray-800", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: "Upload Required" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-red-400", children: "❌ No (client-side)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-green-400", children: "✔ Yes (server upload)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: "Privacy" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-emerald-400", children: "🔒 High" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-yellow-400", children: "⚠ Medium" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: "Speed" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-emerald-400", children: "⚡ Instant" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-gray-400", children: "🐢 Slower" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: "File Storage" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-red-400", children: "❌ None" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-green-400", children: "✔ Stored on servers" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: "File Size Limit" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-emerald-400", children: "✔ Browser RAM only" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-yellow-400", children: "⚠ 50–200MB" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: "Account Required" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-red-400", children: "❌ No signup ever" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-green-400", children: "✔ Often required" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: "Works Offline" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-emerald-400", children: "✔ After first load" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-gray-400", children: "❌ Always online" })
          ] })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-3xl mx-auto px-4 sm:px-6 py-14 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-2", children: "Ready to bolt through your files?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mb-6", children: "20+ free tools. No signup. No uploads. All private." }),
