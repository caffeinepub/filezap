import { c as createLucideIcon, r as reactExports, e as reactDomExports, j as jsxRuntimeExports, b as useComposedRefs, f as createSlot, d as cn } from "./index-ZFlIbF7j.js";
import { L as Label } from "./label-DmvVHTbb.js";
import { u as useDirection, c as createCollection, a as clamp$1 } from "./index-CLIZJmsx.js";
import { P as Primitive, c as createContextScope, b as useLayoutEffect2, u as useControllableState, a as composeEventHandlers } from "./index-7I5fL1gV.js";
import { u as useCallbackRef, a as useId, P as Portal$1, h as hideOthers, b as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, C as Check, T as ToolPageLayout } from "./ToolPageLayout-pYUtqMG4.js";
import { u as useSize, a as usePrevious } from "./index-BU9eVUVJ.js";
...
function ConvertOptions({
  ...
  const [format, setFormat] = reactExports.useState("image/webp");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "mb-2 block text-sm", children: "Output Format" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: format, onValueChange: handleChange, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-full", "data-ocid": "tool.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: FORMATS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: f.value, children: f.label }, f.value)) })
    ] })
  ] });
}
async function convertImageFile(file, targetMime, onProgress) {
  onProgress(10);
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      ...
      const ext = (format == null ? void 0 : format.ext) ?? "jpg";
...
function ConvertImage() {
  const formatRef = reactExports.useRef("image/webp");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ToolPageLayout,
    {
      ...
      processFiles,
      faq,
      optionsPanel: /* @__PURE__ */ jsxRuntimeExports.jsx(ConvertOptions, { formatRef })
    }
  );
}
export {
  ConvertImage as default
};
