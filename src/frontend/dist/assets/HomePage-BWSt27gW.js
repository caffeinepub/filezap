import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useNavigate, Z as Zap, L as Link, B as Button } from "./index-DldcgVMI.js";
import { M as Merge, a as Minimize2, D as DragDropZone, A as ArrowRight, S as Scissors, F as FileOutput, I as Image } from "./DragDropZone-B7xhvUPm.js";
import { F as FileText } from "./file-text-BFCq7ahu.js";
import { L as Lock, U as Users } from "./users-uYx35Evn.js";
/**
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full bg-[#09090b] text-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mb-6", children: "Everything you need to work with PDF files" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: pdfTools.map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-3xl mx-auto px-4 sm:px-6 py-14 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mb-6", children: "Join thousands who use BoltTools.app daily. Free, fast, and private." }),
