import { j as jsxRuntimeExports, _ as __vitePreload } from "./index-BFibDN1D.js";
import { J as JSZip } from "./jszip.min-BbVz9LYn.js";
...
async function processFiles(files, onProgress) {
  ...
  const { getDocument, GlobalWorkerOptions } = await __vitePreload(async () => {
    const { getDocument: getDocument2, GlobalWorkerOptions: GlobalWorkerOptions2 } = await import("./pdf-Z3Rwirrq.js");
