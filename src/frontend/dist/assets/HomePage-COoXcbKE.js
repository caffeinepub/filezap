import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useNavigate, Z as Zap, L as Link, B as Button } from "./index-ZFlIbF7j.js";
import { D as DragDropZone, A as ArrowRight, M as Minimize2, a as Merge, S as Scissors, F as FileOutput, I as Image, b as FileText } from "./DragDropZone-BDudkaDZ.js";
import { S as Shield } from "./shield-DuKf4zA6.js";
import { L as Lock, U as Users } from "./users-DiPlOwm4.js";
/**
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "pt-16 pb-12 px-4 sm:px-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-accent/10 border border-accent/20 rounded-full px-4 py-1.5 text-sm text-accent mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3.5 h-3.5" }),
              "100% Free · No Signup · Instant Processing"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-4", children: [
              "All-in-One Smart",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "brand-gradient-text", children: "File Tools" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto mb-2", children: "Compress, merge, convert & edit files — 100% free, private, and blazing fast." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-4 flex-wrap text-sm text-muted-foreground mb-8", children: [
              "No signup ever",
              "Files never leave your device",
              "Private & secure"
            ].map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-3.5 h-3.5 text-accent" }),
              b
            ] }, b)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-1 mb-10", children: [
              STARS.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Star,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-sm text-muted-foreground", children: "Trusted by thousands daily" })
            ] })
          ]
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 mb-4 flex flex-wrap justify-center gap-6 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "📄 1M+ files processed" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🌍 Users in 50+ countries" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "⚡ Avg. 2s processing time" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🔒 Zero server uploads, ever" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 pb-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6", children: "Everything you need to work with PDF files" }),
            ...
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold group-hover:text-accent transition-colors", children: tool.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: tool.desc })
                ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 pb-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6", children: "Compress, resize and convert images instantly" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "max-w-4xl mx-auto px-4 sm:px-6 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: trustBadges.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 brand-gradient rounded-xl flex items-center justify-center text-white mb-3", children: b.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: b.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: b.sub })
        ]
      },
      b.label
    )) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-3xl mx-auto px-4 sm:px-6 py-12 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-2", children: "Ready to bolt through your files?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "Join thousands who use BoltTools.app daily. It's free, fast and private." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
