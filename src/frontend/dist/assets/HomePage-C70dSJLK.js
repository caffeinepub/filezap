import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useNavigate, Z as Zap, L as Link, B as Button } from "./index-C3IzVc7X.js";
import { M as Merge, a as Minimize2, D as DragDropZone, A as ArrowRight, S as Scissors, F as FileOutput, I as Image } from "./DragDropZone-CNGUWUQx.js";
import { F as FileText, R as RotateCcw } from "./rotate-ccw-DewqcoPc.js";
import { G as GripVertical } from "./grip-vertical-CdelSBnf.js";
import { L as Lock, U as Users, H as HardDrive } from "./users-B9HOWF_M.js";
/**
...
const LockOpen = createLucideIcon("lock-open", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PenLine = createLucideIcon("pen-line", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const featureCards = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldOff, { className: "w-6 h-6" }),
  ...
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UserX, { className: "w-6 h-6" }),
  ...
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HardDrive, { className: "w-6 h-6" }),
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full bg-[#09090b] text-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[#09090b] py-20 px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-widest uppercase text-emerald-500 mb-3", children: "Built Different" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-gray-400 max-w-xl mx-auto", children: "Everything you'd expect from a professional tool — without the compromises." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: featureCards.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 24 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 mb-5", children: card.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "relative z-10 text-lg font-bold text-white mb-2", children: card.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "relative z-10 text-sm text-gray-400 leading-relaxed", children: card.desc })
          ]
        },
        card.title
      )) })
