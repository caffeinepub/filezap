import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useNavigate, Z as Zap, L as Link, B as Button } from "./index-C8sWIOGs.js";
import { M as Merge, a as Minimize2, D as DragDropZone, A as ArrowRight, S as Scissors, F as FileOutput, I as Image } from "./DragDropZone-fVNtZ7PV.js";
import { F as FileText, R as RotateCcw } from "./rotate-ccw-BKRtFsIR.js";
import { G as GripVertical } from "./grip-vertical-D84cBsTV.js";
import { L as Lock, U as Users } from "./users-CeZ1xPfu.js";
/**
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full bg-[#09090b] text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen w-full overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-4 py-1.5 text-sm text-emerald-400 mb-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-[#09090b] py-16 px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl md:text-3xl font-semibold text-center mb-10", children: [
        "Why Choose ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left border border-gray-800 rounded-xl overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-gray-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4 text-gray-400", children: "Other Tools" })
        ] }) }),
