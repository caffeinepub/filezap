...
export class Backend implements backendInterface {
    ...
    async getRecentActivity(): Promise<Array<ToolEvent>> {
        if (this.processError) {
            try {
    ...
    async getToolStats(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getToolStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalFiles(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalFiles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordFile(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.recordFile();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordToolUsage(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async toolExists(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.toolExists(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
